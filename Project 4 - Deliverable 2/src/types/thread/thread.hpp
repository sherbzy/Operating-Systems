...
public:
    ...
    */
    ...
    // // MLFQ Variables
    int thread_priority = 0;    // initialize the priority to 0
    int thread_time_slice = 1;         // initialize the time slice to 2^n = 2^0 = 1
    int thread_runtime = 0;     // initialize the thread's runtime count to 0
